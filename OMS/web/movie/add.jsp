        ...
        <div class="container-fluid">
            ...
            <div class="row m-5 py-5 text-center bg-light">
                <div class="bg-dark border border-dark col-md-4  my-4">
                    <h1 class="text-light py-1">Create Movie</h1>
                </div>
                <div class="col-md-8 offset-md-2 my-5">
                        <form action="<%=url %>/AddMovieServlet" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" name="genre" class="form-control" placeholder="genre">
                            </div>
                            <div class="form-group">
                                <label class="float-left pt-4">PRICE</label>
                                <input type="name" name="price" class="form-control" placeholder="price">
                            </div>
                            <div class="form-group">
                                <label class="float-left pt-4">AMOUNT</label>
                                <input type="name" name="amount" class="form-control mb-3" placeholder="amount">
                            </div>
                                <button type="submit" class="btn btn-lg btn-dark mt-5">Create Movie</button> 
                        </form>
                </div>
            </div>
        </div>
