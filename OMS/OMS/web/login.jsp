    ...
    <body style="background-color: #ccb483">
        ...
        <div class="container-fluid">
            ...
            <div class="row m-5 py-5 text-center bg-light">
                <div class="btn bg-light border border-dark col-md-4 offset-md-2 my-4">
                    <a class="h1 text-dark py-1" href="login.jsp" style="text-decoration: none;">Sign in</a>
                </div>
                <div class="col-md-8 offset-md-2 my-5">
                        <form action="<%=url %>/LoginServlet" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-lg btn-dark mt-5">Sign in</button> 
                        </form>
                </div>
            </div>
        </div>
